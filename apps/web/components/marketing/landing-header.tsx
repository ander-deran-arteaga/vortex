 ...
 * marketing page and belongs where it is used. It carries the page's only
 * Launch App, which is why it is sticky — the action is always one click away
 * instead of being repeated down the page.
 *
